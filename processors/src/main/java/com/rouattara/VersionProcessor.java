...
@AutoService(Processor.class) @SupportedAnnotationTypes({ "com.rouattara.annotations.Version" })
@SupportedSourceVersion(SourceVersion.RELEASE_8) public class VersionProcessor
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    ...
    for (TypeElement currentAnnotation : annotations) {
      ...
      if (qualifiedName.contentEquals("com.rouattara.annotations.Version")) {
